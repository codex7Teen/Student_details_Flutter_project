                                  ...
                                  IconButton(
                                      onPressed: () {
                                        Navigator.of(context)
                                            ...
                                            .then((data) =>
                                                data != null ? getAllStudentDetails() : null);
                                        ;
                                      },
                                      icon: Icon(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        screenViewStudent(student: _studentList[index]),
                                  ),
                                );
                              },
                              child: GridTile(
                                child: Column(
                                  ...
                                  children: [
                                    _studentList[index].image != ''
                                        ...
                                        : const Icon(Icons.person_3_outlined, size: 80,),
                                    Text(
                                      _studentList[index].name ?? '',
                                      style: const TextStyle(
                                          fontWeight: FontWeight.w500),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          onPressed: () {
                                            _deleteStudentFromTile(context, _studentList[index].id);
                                          },
                                          icon: Icon(Icons.delete_outline_outlined, color: Colors.red[300]),
                                        ),
                                      ],
                                    ),
                                  ],
