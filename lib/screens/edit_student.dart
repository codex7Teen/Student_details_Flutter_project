...
class screenEditStudent extends StatefulWidget {
  ...
  const screenEditStudent({super.key, required this.student});
...
class _screenEditStudentState extends State<screenEditStudent> {
  ...
  void initState() {
    setState(() {
      ...
      _numberController.text = widget.student.number ?? '';
      newimage = widget.student.image ;
                ...
                children: [
                  ...
                  //Address-field***************
                   TextFormField(
                    ...
                    validator: (address) => address!.isEmpty ? 'Please enter an address' : null,
                    autovalidateMode: AutovalidateMode.onUserInteraction,
                    decoration: const InputDecoration(
                      border: OutlineInputBorder(),
                  ...
                  //Number-Field***************
                   TextFormField(
                    ...
                    validator: (number) => number!.isEmpty ? 'Please enter a number': null,
                    autovalidateMode: AutovalidateMode.onUserInteraction,
                    decoration: const InputDecoration(
                      border: OutlineInputBorder(),
                        ...
                        //Validation work on save-button click
                          ...
                          if(_nameController.text.isNotEmpty &&
                           ...
                           _numberController.text.isNotEmpty) {
                            ...
                            _showSuccessSnackBar('Student details updated successfully ...'); 
